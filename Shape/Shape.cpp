...
Shape::Shape(const Shape &other)
    : m_selected(other.m_selected), m_dirty(other.m_dirty), m_boundingRectDirty(other.m_boundingRectDirty), m_cachedBoundingRect(other.m_cachedBoundingRect), m_path(other.m_path),
      m_originalPath(other.m_originalPath), m_color(other.m_color), m_rotation(other.m_rotation), m_transform(other.m_transform), m_groupId(other.m_groupId)
{
}
...
Shape::Shape() : m_selected(false), m_dirty(true), m_boundingRectDirty(true), m_color(Qt::black), m_rotation(0.0)
{
}
