...
QColor DXFTranslator::convertAciToQColor(int aci) const
{
    ...
    static const std::map<int, QColor> ACI_TO_QCOLOR_MAP = {
        ...
        {10, QColor(255, 0, 0)},
        {11, QColor(255, 127, 127)},
        {12, QColor(204, 0, 0)},
        {13, QColor(204, 102, 102)},
        {14, QColor(153, 0, 0)},
        {15, QColor(153, 76, 76)},
        {16, QColor(127, 0, 0)},
        {17, QColor(127, 63, 63)},
        ...
        {19, QColor(76, 38, 38)},
        {20, QColor(255, 63, 0)},
        {21, QColor(255, 159, 127)},
        {22, QColor(204, 51, 0)},
        {23, QColor(204, 127, 102)},
        {24, QColor(153, 38, 0)},
        {25, QColor(153, 95, 76)},
        {26, QColor(127, 31, 0)},
        {27, QColor(127, 79, 63)},
        ...
        {29, QColor(76, 47, 38)},
        {30, QColor(255, 127, 0)},
        {31, QColor(255, 191, 127)},
        {32, QColor(204, 102, 0)},
        {33, QColor(204, 153, 102)},
        {34, QColor(153, 76, 0)},
        {35, QColor(153, 114, 76)},
        {36, QColor(127, 63, 0)},
        {37, QColor(127, 95, 63)},
        {38, QColor(76, 38, 0)},
        {39, QColor(76, 57, 38)},
        {40, QColor(255, 191, 0)},
        {41, QColor(255, 223, 127)},
        {42, QColor(204, 153, 0)},
        {43, QColor(204, 178, 102)},
        {44, QColor(153, 114, 0)},
        {45, QColor(153, 133, 76)},
        {46, QColor(127, 95, 0)},
        {47, QColor(127, 111, 63)},
        {48, QColor(76, 57, 0)},
        {49, QColor(76, 66, 38)},
        {50, QColor(255, 255, 0)},
        {51, QColor(255, 255, 127)},
        {52, QColor(204, 204, 0)},
        {53, QColor(204, 204, 102)},
        {54, QColor(153, 153, 0)},
        {55, QColor(153, 153, 76)},
        {56, QColor(127, 127, 0)},
        {57, QColor(127, 127, 63)},
        {58, QColor(76, 76, 0)},
        {59, QColor(76, 76, 38)},
        {60, QColor(191, 255, 0)},
        {61, QColor(223, 255, 127)},
        {62, QColor(153, 204, 0)},
        {63, QColor(178, 204, 102)},
        {64, QColor(114, 153, 0)},
        {65, QColor(133, 153, 76)},
        {66, QColor(95, 127, 0)},
        {67, QColor(111, 127, 63)},
        {68, QColor(57, 76, 0)},
        {69, QColor(66, 76, 38)},
        {70, QColor(127, 255, 0)},
        {71, QColor(191, 255, 127)},
        {72, QColor(102, 204, 0)},
        {73, QColor(153, 204, 102)},
        {74, QColor(76, 153, 0)},
        {75, QColor(114, 153, 76)},
        {76, QColor(63, 127, 0)},
        {77, QColor(95, 127, 63)},
        {78, QColor(38, 76, 0)},
        {79, QColor(57, 76, 38)},
        {80, QColor(63, 255, 0)},
        {81, QColor(159, 255, 127)},
        {82, QColor(51, 204, 0)},
        {83, QColor(127, 204, 102)},
        {84, QColor(38, 153, 0)},
        {85, QColor(95, 153, 76)},
        {86, QColor(31, 127, 0)},
        {87, QColor(79, 127, 63)},
        ...
        {89, QColor(47, 76, 38)},
        {90, QColor(0, 255, 0)},
        {91, QColor(127, 255, 127)},
        {92, QColor(0, 204, 0)},
        {93, QColor(102, 204, 102)},
        {94, QColor(0, 153, 0)},
        {95, QColor(76, 153, 76)},
        {96, QColor(0, 127, 0)},
        {97, QColor(63, 127, 63)},
        ...
        {99, QColor(38, 76, 38)},
        {100, QColor(0, 255, 63)},
        {101, QColor(127, 255, 159)},
        {102, QColor(0, 204, 51)},
        {103, QColor(102, 204, 127)},
        {104, QColor(0, 153, 38)},
        {105, QColor(76, 153, 95)},
        {106, QColor(0, 127, 31)},
        {107, QColor(63, 127, 79)},
        {108, QColor(0, 76, 19)},
        {109, QColor(38, 76, 47)},
        {110, QColor(0, 255, 127)},
        {111, QColor(127, 255, 191)},
        {112, QColor(0, 204, 102)},
        {113, QColor(102, 204, 153)},
        {114, QColor(0, 153, 76)},
        {115, QColor(76, 153, 114)},
        {116, QColor(0, 127, 63)},
        {117, QColor(63, 127, 95)},
        {118, QColor(0, 76, 38)},
        {119, QColor(38, 76, 57)},
        {120, QColor(0, 255, 191)},
        {121, QColor(127, 255, 223)},
        {122, QColor(0, 204, 153)},
        {123, QColor(102, 204, 178)},
        {124, QColor(0, 153, 114)},
        {125, QColor(76, 153, 133)},
        {126, QColor(0, 127, 95)},
        {127, QColor(63, 127, 111)},
        {128, QColor(0, 76, 57)},
        {129, QColor(38, 76, 66)},
        {130, QColor(0, 255, 255)},
        {131, QColor(127, 255, 255)},
        {132, QColor(0, 204, 204)},
        {133, QColor(102, 204, 204)},
        {134, QColor(0, 153, 153)},
        {135, QColor(76, 153, 153)},
        {136, QColor(0, 127, 127)},
        {137, QColor(63, 127, 127)},
        {138, QColor(0, 76, 76)},
        {139, QColor(38, 76, 76)},
        {140, QColor(0, 191, 255)},
        {141, QColor(127, 223, 255)},
        {142, QColor(0, 153, 204)},
        {143, QColor(102, 178, 204)},
        {144, QColor(0, 114, 153)},
        {145, QColor(76, 133, 153)},
        {146, QColor(0, 95, 127)},
        {147, QColor(63, 111, 127)},
        {148, QColor(0, 57, 76)},
        {149, QColor(38, 66, 76)},
        {150, QColor(0, 127, 255)},
        {151, QColor(127, 191, 255)},
        {152, QColor(0, 102, 204)},
        {153, QColor(102, 153, 204)},
        {154, QColor(0, 76, 153)},
        {155, QColor(76, 114, 153)},
        {156, QColor(0, 63, 127)},
        {157, QColor(63, 95, 127)},
        {158, QColor(0, 38, 76)},
        {159, QColor(38, 57, 76)},
        {160, QColor(0, 63, 255)},
        {161, QColor(127, 159, 255)},
        {162, QColor(0, 51, 204)},
        {163, QColor(102, 127, 204)},
        {164, QColor(0, 38, 153)},
        {165, QColor(76, 95, 153)},
        {166, QColor(0, 31, 127)},
        {167, QColor(63, 79, 127)},
        {168, QColor(0, 19, 76)},
        {169, QColor(38, 47, 76)},
        {170, QColor(0, 0, 255)},
        {171, QColor(127, 127, 255)},
        {172, QColor(0, 0, 204)},
        {173, QColor(102, 102, 204)},
        {174, QColor(0, 0, 153)},
        {175, QColor(76, 76, 153)},
        {176, QColor(0, 0, 127)},
        {177, QColor(63, 63, 127)},
        {178, QColor(0, 0, 76)},
        {179, QColor(38, 38, 76)},
        {180, QColor(63, 0, 255)},
        {181, QColor(159, 127, 255)},
        {182, QColor(51, 0, 204)},
        {183, QColor(127, 102, 204)},
        {184, QColor(38, 0, 153)},
        {185, QColor(95, 76, 153)},
        {186, QColor(31, 0, 127)},
        {187, QColor(79, 63, 127)},
        {188, QColor(19, 0, 76)},
        {189, QColor(47, 38, 76)},
        {190, QColor(127, 0, 255)},
        {191, QColor(191, 127, 255)},
        {192, QColor(102, 0, 204)},
        {193, QColor(153, 102, 204)},
        {194, QColor(76, 0, 153)},
        {195, QColor(114, 76, 153)},
        {196, QColor(63, 0, 127)},
        {197, QColor(95, 63, 127)},
        {198, QColor(38, 0, 76)},
        {199, QColor(57, 38, 76)},
        {200, QColor(191, 0, 255)},
        {201, QColor(223, 127, 255)},
        {202, QColor(153, 0, 204)},
        {203, QColor(178, 102, 204)},
        {204, QColor(114, 0, 153)},
        {205, QColor(133, 76, 153)},
        {206, QColor(95, 0, 127)},
        {207, QColor(111, 63, 127)},
        {208, QColor(57, 0, 76)},
        {209, QColor(66, 38, 76)},
        {210, QColor(255, 0, 255)},
        {211, QColor(255, 127, 255)},
        {212, QColor(204, 0, 204)},
        {213, QColor(204, 102, 204)},
        {214, QColor(153, 0, 153)},
        {215, QColor(153, 76, 153)},
        {216, QColor(127, 0, 127)},
        {217, QColor(127, 63, 127)},
        {218, QColor(76, 0, 76)},
        {219, QColor(76, 38, 76)},
        {220, QColor(255, 0, 191)},
        {221, QColor(255, 127, 223)},
        {222, QColor(204, 0, 153)},
        {223, QColor(204, 102, 178)},
        {224, QColor(153, 0, 114)},
        {225, QColor(153, 76, 133)},
        {226, QColor(127, 0, 95)},
        {227, QColor(127, 63, 111)},
        {228, QColor(76, 0, 57)},
        {229, QColor(76, 38, 66)},
        {230, QColor(255, 0, 127)},
        {231, QColor(255, 127, 191)},
        {232, QColor(204, 0, 102)},
        {233, QColor(204, 102, 153)},
        {234, QColor(153, 0, 76)},
        {235, QColor(153, 76, 114)},
        {236, QColor(127, 0, 63)},
        {237, QColor(127, 63, 95)},
        {238, QColor(76, 0, 38)},
        {239, QColor(76, 38, 57)},
        {240, QColor(255, 0, 63)},
        {241, QColor(255, 127, 159)},
        {242, QColor(204, 0, 51)},
        {243, QColor(204, 102, 127)},
        {244, QColor(153, 0, 38)},
        {245, QColor(153, 76, 95)},
        {246, QColor(127, 0, 31)},
        {247, QColor(127, 63, 79)},
        {248, QColor(76, 0, 19)},
        {249, QColor(76, 38, 47)},
        {250, QColor(51, 51, 51)},
        {251, QColor(91, 91, 91)},
        {252, QColor(132, 132, 132)},
        {253, QColor(173, 173, 173)},
        {254, QColor(214, 214, 214)},
        {255, QColor(255, 255, 255)}
    };
